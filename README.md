...
Explore 2,803 abandoned and little-known airfields in ForeFlight. The version
...
- A separate ForeFlight Content Pack for every state
- Readable state-prefixed waypoint names
- Historical-airfield map markers and state-specific map layers
- An offline illustrated PDF history attached to every waypoint
- Source links, captions, contributor credits, and available historical images
...
Do not use these packs for navigation, flight planning, landing decisions, or
